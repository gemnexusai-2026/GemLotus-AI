...
type FactoryDecisionPanelProps = {
  readiness: FactoryReadinessResult;
  compliance: FactoryComplianceResult;
};

export default function FactoryDecisionPanel({
  readiness,
  compliance,
}: FactoryDecisionPanelProps) {
  return (
    <section className="min-w-0 rounded-[24px] border border-white/[0.08] bg-white/[0.025]">
      <div className="border-b border-white/[0.06] p-5">
        ...
        <h2 className="mt-2 text-lg font-semibold text-white">
          Factory Readiness & Decision
        </h2>

        <p className="mt-2 text-[10px] leading-5 text-white/30">
          Consolidated infrastructure readiness,
          compliance blockers, required actions and
