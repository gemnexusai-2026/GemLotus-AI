        ...
        <div className="flex min-w-0 flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-2 max-w-3xl text-[10px] leading-5 text-white/30 sm:text-[11px]">
              Verify legal identity, statutory registrations,
              document validity, verification status, risk
              and assessment readiness.
            </p>
          </div>

          <div className="grid min-w-0 grid-cols-2 gap-3 sm:grid-cols-4 xl:w-auto">
            <Metric
              label="Documents"
              value={String(
                documentCount,
